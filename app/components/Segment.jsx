  ...
  return (
    <div className='w-screen bg-(--Segment) h-full flex items-center justify-center py-16'>
      ...
      <div className='w-4/5 max-w-5xl bg-white rounded-3xl flex flex-col px-8 py-10 gap-12 relative '>
        {/* Main Title */}
        <div className='font-poppins text-3xl text-(--TEXT1) font-bold'>
          OUR SEGMENTS
        </div>

        <div className='flex gap-6 font-poppins justify-center'>
          {/* Box 1 */}
          <div className='relative w-1/3 aspect-[3/4] rounded-2xl overflow-hidden'>
          ...
          <div className='relative w-1/3 aspect-[3/4] rounded-2xl overflow-hidden'>
            ...
            <div className='relative z-10 text-white h-1/2 justify-center flex flex-col  items-center p-4'>
              <div className='w-3/5 text-center'>
                <div className='text-2xl font-semibold'>Agriculture</div>
                <div className='text-xs mt-1'>
